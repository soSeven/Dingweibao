...
class MessageViewController: ViewController {
    ...
    private func setupBinding() {
        ...
        let input = ListViewModel<MessageListModel>.Input(headerRefresh: Observable.merge(headerRefreshTrigger, errorBtnTap.asObservable().startWith(())),
        ...
        output.showEmptyView.distinctUntilChanged().bind(to: rx.showEmptyView(imageName: "message_defaultpage", title: "暂无消息")).disposed(by: rx.disposeBag)
